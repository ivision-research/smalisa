...
bitflags! {
    ...
    pub struct InsBits: u64 {
        ...
        /// The instruction itself may throw (note that this is not set on
        /// invoke-* variants)
...
ins!(
    ...
    27,
    ACTION_SETS_REGISTER | CFMT_REG_STR
);
ins!(INS_CONST_METHOD_TYPE, 28, ACTION_SETS_REGISTER);
ins!(INS_CONST_METHOD_HANDLE, 29, ACTION_SETS_REGISTER);
...
ins!(INS_CHECK_CAST, 126, ACTION_THROW | CFMT_REG_CLASS);
ins!(INS_NEW_INSTANCE, 127, ACTION_SETS_REGISTER | CFMT_REG_CLASS);
ins!(INS_CONST_CLASS, 128, ACTION_SETS_REGISTER | CFMT_REG_CLASS);
ins!(
    INS_ADD_INT_LIT8,
    129,
...
ins!(INS_IPUT_CHAR_QUICK, 170, ACTION_SETS_INSTANCE_FIELD);
ins!(INS_IPUT_SHORT_QUICK, 171, ACTION_SETS_INSTANCE_FIELD);
...
ins!(INS_DIV_INT, 205, ACTION_SETS_REGISTER | CFMT_REG_REG_REG);
ins!(INS_REM_INT, 206, ACTION_SETS_REGISTER | CFMT_REG_REG_REG);
...
ins!(
    ...
    240,
    ACTION_SETS_RESULT | CFMT_ARGS_ARR
);
ins!(
...
ins!(
    INS_EXECUTE_INLINE,
    242,
    ACTION_SETS_RESULT | ACTION_INVOKE | CFMT_ARGS_METHOD
);
ins!(
...
ins!(
    INS_INVOKE_CUSTOM,
    244,
    ACTION_SETS_RESULT | ACTION_INVOKE | CFMT_ARGS_METHOD_CUSTOM
);
ins!(
    INS_INVOKE_VIRTUAL,
    245,
...
ins!(
    ...
    253,
    ACTION_SETS_RESULT | ACTION_INVOKE | CFMT_ARGS_METHOD_POLYMORPHIC
);
ins!(
